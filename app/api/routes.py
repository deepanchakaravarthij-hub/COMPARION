...
async def compare(
    ...
    background_tasks.add_task(_run_compare_job, job_id, file_a.filename, file_b.filename, content_a, content_b)
...
def job_status(job_id: str) -> JobStatusResponse:
    ...
    return JobStatusResponse(job_id=job_id, status=job["status"], file_a=job["file_a"], file_b=job["file_b"])
...
def _run_compare_job(job_id: str, file_a_name: str, file_b_name: str, content_a: bytes, content_b: bytes) -> None:
