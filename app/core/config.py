...
class Settings:
    ...
    image_supplement_visual: bool = _get_bool("COMPARION_IMAGE_SUPPLEMENT_VISUAL", False)
    image_value_text_only: bool = _get_bool("COMPARION_IMAGE_VALUE_TEXT_ONLY", True)
    image_ssim_threshold: float = _get_float("COMPARION_IMAGE_SSIM_THRESHOLD", 0.95)
    soffice_path: str = getenv("COMPARION_SOFFICE_PATH", "")
